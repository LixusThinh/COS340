    ...
    <ul>
        <?php foreach ($products as $product): ?>
            <li>
                ...
                <a href="/project1/Product/edit/<?php echo $product->getID(); ?>">Sửa</a> | 
                <a href="/project1/Product/delete/<?php echo $product->getID(); ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?');">Xóa</a>
            </li>
        <?php endforeach; ?>
    </ul>
</body>
